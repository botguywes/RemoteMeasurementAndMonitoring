...
//-- System definitions --
#define terminal_baud_rate                9600                        // This baud rate should match the terminal application settings
...
//-- Display the results on the terminal --
  Serial.print("Analog = [");                                   // Print the analog results
